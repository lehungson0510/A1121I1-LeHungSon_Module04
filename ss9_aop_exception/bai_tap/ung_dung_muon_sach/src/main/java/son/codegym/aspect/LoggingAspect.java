...
public class LoggingAspect {
    private Logger logger = Logger.getLogger(son.codegym.aspect.LoggingAspect.class.getName());

    @Pointcut("execution(* son.codegym.service.BookServiceImpl.*(..))")
